...
patterns above the line. If we hav a match, we rewrite according to
...
\begin{align}
  ...
  1 &= \lamAbs{s}{\lamAbs{z}{\lamApp{s}{z}}}. \\
    ...
    2 &= \lamAbs{s}{\lamAbs{s}{\lamAbs{z}{\lamApp{s}{\lamPApp{s}{z}}}}}. \\
    3 &= \lamAbs{s}{\lamAbs{s}{\lamAbs{s}{\lamAbs{z}{\lamApp{s}{\lamPApp{s}{\lamPApp{s}{z}}}}}}}.
    \intertext{}
    
\end{align}

We can interpret the number of $s$ terms as the natural represented by
...
\begin{align}
  succ &= \lamAbs{n}{\lamAbs{s}{\lamApp{s}{n}}.} \text{(\bf{verify!})} 
  \intertext{We can find the sum of two numbers with $add$:}
  add &= \lamAbs{m}{\lamAbs{n}{\lamApp{m}{n}}}.
