...
other values. Figure \ref{lang_fig3}, Part \subref{lang_fig3_syntax}, gives the syntax of the pure
...
Part \subref{lang_fig3_eval} shows to evaluate \lamA terms. Each rule
...
\begin{myfig}[ht]
  \begin{tabular}{cc}
    \subfloat{\input{lang_fig3_syntax}\label{lang_fig3_syntax}} & %%
    \subfloat{\input{lang_fig3_eval}\label{lang_fig3_eval}} \\
    \subref{lang_fig3_syntax} & \subref{lang_fig3_eval}
  \end{tabular}
  \caption{In \subref{lang_fig3_syntax}, the \lamA' syntax;
    \subref{lang_fig3_eval} shows how to evaluate \lamA terms using
