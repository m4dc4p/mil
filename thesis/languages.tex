...
\compMach{t}, represent our compiler, with the term being
...
Function application, \lamPApp{f}{g}, is shown in case
...
by \lamAbs{x}{(\mathellipsis)} must copy all values in the existing
