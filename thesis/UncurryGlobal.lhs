...
>     rename :: [Name] -> Stmt C O -> Name -> Name
...
> collapseRewrite :: FuelMonad m => Map Label DestOf -> FwdRewrite m Stmt CollapseFact
> collapseRewrite blocks = iterFwdRw (mkFRewrite rewriter)
>   where
>     rewriter :: FuelMonad m => forall e x. Stmt e x -> CollapseFact -> m (Maybe (ProgM e x))
