...
%%
\newdimen\termalign
\setbox0=\hbox{\ensuremath{:=\ \ }}
\termalign=\wd0 
\def\term#1/{\ensuremath{\mathit{#1}}}
\def\syntaxrule#1/{\hfil\text{\emph{#1}}}
\def\termrule#1:#2:#3/{\term #1/ &:= #2 & \syntaxrule #3/}
\def\termcase#1:#2/{&\hbox to \termalign{\ensuremath{\phantom{:}|}}\ensuremath{#1} & \syntaxrule #2/}
