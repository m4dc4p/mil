...
\titleformat{\chapter}[display]
            ...
            {\sffamily\bfseries}
            {}
%% \usepackage[raggedright]{titletoc}
%% \titlecontents{chapter}[1.5in]
%%         {\bigskip}%% above
%%         {\bfseries Chapter \thecontentslabel\ }%% before with label
%%         {}%% before w/o label
%%         {\titlerule*[1pc]{.}\thecontentspage}%% filler and page
%%         {}%% after
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
