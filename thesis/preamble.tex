...
%%\usepackage{tgbonum} %% TEX Gyre Bonum (http://www.tug.dk/FontCatalogue/tgbonum/)
%%\usepackage{tgschola} %% TEX Gyre Schola (http://www.tug.dk/FontCatalogue/tgschola/)
%%%%\usepackage{DejaVuSansMono}
%%\usepackage{DejaVuSerifCondensed} %% DejaVu Serif Condensed (http://www.tug.dk/FontCatalogue/dejavuserifcondensed/)
%% \let\oldtt=\texttt \let\oldttfamily=\ttfamily
%% \renewcommand\texttt[1]{\fontsize{13}{1.08333\baselineskip}\oldtt{#1}}
%% \renewcommand\ttfamily{\fontsize{13}{1.08333\baselineskip}\oldttfamily}
