...
%% Construct a thunk
\newdimen\brackl\newdimen\brackr 
\setbox0=\hbox{\ensuremath{\{}}\brackl=\wd0
\setbox0=\hbox{\ensuremath{\}}}\brackr=\wd0
\protected\long\def\mkthunk[#1:#2]{\lab #1/\ensuremath{\,%%
    \mathopen{\hbox to \brackl{\hfil[}}}%%
    \ensurett{#2}%%
    \mathclose{\hbox to \brackr{]\hfil}}\xspace}
%% Binding statement: v <- {...}
