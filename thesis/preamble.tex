...
\protected\long\def\ccblock#1(#2)#3:{\lab#1/\ \ensuremath{\{\ensurett{#2}\}}\ \ensurett{#3:}}
%% A normal block
\protected\long\def\block#1(#2):{\lab #1/\ \ensuremath{(\ensurett{#2})}\ensurett{:}}
%% A goto expression
...
\protected\def\prim#1(#2){\lab #1/*\ensuremath{(\ensurett{#2})}}
