...
\newcommand{\facts}[1]{\begingroup%%
  ...
  \ensuremath{\{%%
    ...
    \foreach \var in {#1}{%%
      ...
      \ifthenelse{\value{factctr}>0}{,}{}%%
      %% \tracingmacros=1%%
      %% If key/val arguments, use first form. Otherwise
      %% use second.
      \ifthenelse{\equal{\hasSlash{\var}}{Y}}%%
                  {\expandafter\getArgs\var \mathit{\the\varName}=\the\varVal}%%
                  {\var}%%{\var}%%
      %% \tracingmacros=0%%
      \stepcounter{factctr}%%
    }\}}\xspace%%
...
\newcommand{\inFacts}[2]{\ensuremath{\inB{#1}: \facts{#2}}}
\newcommand{\outFacts}[2]{\ensuremath{\outB{#1}: \facts{#2}}}

%% least upper bound operator. Raised outside mathmode
\newcommand{\lub}{\ifthenelse{\boolean{mmode}}{\sqcap}{\raisebox{.1em}{\ensuremath{\sqcap}}}}
%% End dataflow
...
%% Paragraph run-in
\newcommand{\runin}[1]{\begingroup\noindent\sffamily\sc #1\qquad\endgroup}
