...
\protected\def\lab#1/{\ensuremath{\mathbf{\mathtt{#1}}}\xspace}
...
\long\def\clo[#1:#2]{\ensuremath{\ensurett{\{%%
      ...
      \fi#2\}}\xspace}}
%% Binding statement: v <- {...}
\long\def\binds#1<-#2;{\ensurett{#1<-#2}\xspace}
\long\def\bindsX#1<-#2sdnib{\ensurett{#1<-#2}\xspace}
%% Return statement: return ... ;
\long\def\return#1;{\ensuremath{\ensurett{return\ #1}}\xspace}
...
\DefineVerbatimEnvironment{AVerb}{Verbatim}{commandchars=\\\{\},%% 
  codes={\catcode`\_8\catcode`\$3\catcode`\^7\catcode`\;12},%%
