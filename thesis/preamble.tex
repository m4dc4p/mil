...
%% Marginal notes
\newcommand\margin[2]{#1\begin{singlespace}\emph{\footnotesize\marginpar{Intent: #2}}\end{singlespace}}

%% Describe intent of a passage
\newcommand\intent[1]{\begin{singlespace}\emph{\footnotesize{#1}}\end{singlespace}}
