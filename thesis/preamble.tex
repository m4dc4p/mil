...
\long\def\mkclo[#1:#2]{\ensuremath{\tracingmacros=2\tracingcommands=1\ensurett{#1\ \{#2\}}}\xspace}
%% Tuple version of closurs: (l, v1, ..., vN).
\long\def\clo[#1:#2]{\ensuremath{\ensurett{(#1, #2)}}\xspace}
%% Binding statement: v <- {...}
\long\def\binds#1<-#2/{\ensuremath{\ensurett{#1\ \texttt{<-}\ #2}}\xspace}
