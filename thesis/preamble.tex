...
\newcommand{\Out}{\ensurmath{\mathit{Out}}\xspace}
\newcommand{\OutBa}{\ensurmath{\mathit{Out}(B)}\xspace}
...
%% out(B) -- fact function for an anonymous block, but using a different variable.
