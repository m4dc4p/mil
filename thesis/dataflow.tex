...
\begin{myfig}
  \begin{tabular}{lccccc}
    Node & 1 & 2 & 3 & 4 \\\midrule 
    \outXa{\textsc{E}} & \facts{m/\bot,n/\bot,i/\bot} & \dots \\\\
    \inB{lst_back15_assign} & \facts{m/\bot,n/\bot,i/\bot} & \dots \\ 
    \outB{lst_back15_assign} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/{10},n/1,i/0} & \dots \\ \\
    \inB{lst_back15_test} & \facts{m/\bot,n/\bot,i/\bot} & \dots & \facts{m/{10},n/\bot,i/\bot} \\
    \outB{lst_back15_test} & \facts{m/\bot,n/\bot,i/\bot} & \dots & \facts{m/\bot,n/\bot,i/\bot} \\\\
    \inB{lst_back15_mult} & \facts{m/\bot,n/\bot,i/\bot} & \dots & \dots \\
    \outB{lst_back15_mult} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/\bot,n/\top,i/\bot} & \dots \\\\
    \inB{lst_back15_incr} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/\bot,n/\top,i/\bot}   \\
    \outB{lst_back15_incr} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/\bot,n/\bot,i/\top} & \facts{m/\bot,n/\top,i/\bot} \\\\
    \inB{lst_back15_return} & \facts{m/\bot,n/\bot,i/\bot} & \dots  & \\
    \outB{lst_back15_return} & \facts{m/\bot,n/\bot,i/\bot} & \dots  \\\\
    \inXa{\textsc{X}} & \facts{m/\bot,n/\bot,i/\bot} & \dots
  \end{tabular}
