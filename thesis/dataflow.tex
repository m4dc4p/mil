...
is embedded in a loop.  The fact \inB{lst_back7_assign}, \facts{a/\bot,
b/\bot, c/\bot}, represents our lack of information by assigning
each variable the value ``$\bot$'' (``bottom''). After
\refNode{lst_back7_assign}, \outB{lst_back7_assign} is \facts{a/1,
  b/2, c/\bot}, showing that we know #a# is 1, #b# is 2, and we still
