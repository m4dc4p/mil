...
operate over sets of pairs, \outB{lst_back17_assign} \lub
\outB{lst_back17_incr} is equivalent to \inB{lst_back17_test} (as in
...
Figure~\ref{fig_back8}, Part~\subref{fig_back8_initial} shows our
...
Part~\subref{fig_back8_final} shows the facts computed after our
constant propagation analysis has terminated.

\begin{myfig}
  \begin{tabular}{lp{0.8in}lccccc}
    & & Node & 0 & 1 & 2 & 3 \\
    & & \outXa{\textsc{E}} & \facts{m/\bot,n/\bot,i/\bot} & --- \\\\
\tikz[remember picture] \node[table] (assign) {}; & \begin{minipage}{0.5in} %%
  \begin{AVerb} 
m = 10
n = 1
i = 0
  \end{AVerb}
\end{minipage} & \inB{lst_back15_assign} & \facts{m/\bot,n/\bot,i/\bot} & --- \\ 
    & & \outB{lst_back15_assign} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/{10},n/1,i/0} & --- \\ \\
    \tikz[remember picture] \node[table] (test) {}; & #i < cnt# & \inB{lst_back15_test} & \facts{m/\bot,n/\bot,i/\bot} & --- & \facts{m/{10},n/\bot,i/\top} \\
    & & \outB{lst_back15_test} & \facts{m/\bot,n/\bot,i/\bot} & --- & \facts{m/{10},n/\top,i/\top} \\\\
    \tikz[remember picture] \node[table] (mult) {}; & #n = val * m# & \inB{lst_back15_mult} & \facts{m/\bot,n/\bot,i/\bot} & --- & --- \\
    & & \outB{lst_back15_mult} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/\bot,n/\top,i/\bot} & --- \\\\
    \tikz[remember picture] \node[table] (incr) {}; & #i++# & \inB{lst_back15_incr} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/\bot,n/\top,i/\bot}   \\
    & & \outB{lst_back15_incr} & \facts{m/\bot,n/\bot,i/\bot} & \facts{m/\bot,n/\bot,i/\top} & \facts{m/\bot,n/\top,i/\bot} \\\\
    \tikz[remember picture] \node[table] (return) {}; & #return n# & \inB{lst_back15_return} & \facts{m/\bot,n/\bot,i/\bot} & ---  & \\
    & & \outB{lst_back15_return} & \facts{m/\bot,n/\bot,i/\bot} & ---  \\\\
    & & \inXa{\textsc{X}} & \facts{m/\bot,n/\bot,i/\bot} & ---
  \end{tabular}
  \caption{This table illustrates how facts change for each iteration
    when applying our constant propagation analysis to our sample
    program. The nodes {\sc E} and {\sc X} represent the invisible
    \emph{entry} and \emph{exit} nodes.}
  \label{tbl_back5}
\end{myfig}
...
\begin{tikzpicture}[overlay, remember picture]
  ...
  \draw[->] (incr.west) -|| ++(-4mm,0cm) ||- (test.west);
  \draw[->] (incr.south) -|| (return.north);
\end{tikzpicture}
